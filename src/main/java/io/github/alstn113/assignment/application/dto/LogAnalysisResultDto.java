...
public record LogAnalysisResultDto(
        ...
        @Schema(description = "에러 메시지 (FAILED 시)", example = "파싱 실패") String errorMessage,
    ...
    public record PathCount(
            @Schema(description = "요청 경로", example = "/api/users") String path,
            @Schema(description = "요청 횟수", example = "1500") long count
    ) {
    ...
    public record StatusCodeCount(
            ...
            @Schema(description = "요청 횟수", example = "8500") long count
    ) {
    ...
    public record IpCount(
            @Schema(description = "IP 주소", example = "192.168.1.1") String ip,
            @Schema(description = "요청 횟수", example = "500") long count,
